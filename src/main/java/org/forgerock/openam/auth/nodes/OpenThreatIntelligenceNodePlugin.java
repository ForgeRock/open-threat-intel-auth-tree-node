...
public class OpenThreatIntelligenceNodePlugin extends AbstractNodeAmPlugin {
    ...
    protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
        return Collections.singletonMap(OpenThreatIntelligenceNodePlugin.currentVersion,
                Collections.singletonList(OpenThreatIntelligenceNode.class));
    }
    ...
    public String getPluginVersion() {
        return OpenThreatIntelligenceNodePlugin.currentVersion;
    }
}
